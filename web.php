...
Route::get('verify/account/{confirmation_code}', [HomeController::class, 'getVerifyAccount'])->where('confirmation_code','[A-Za-z0-9]+');
 ...
 Route::group(['middleware' => 'auth'], function() {
	...
	Route::post("profile/payments/card", [UserController::class, 'updatePaymentMethod']);
	...
	Route::post('/add-update-payment-card', [App\Http\Controllers\UserController::class, 'addUpdatePaymentCard'])->name('add.update.payment.card');
	...
	Route::post('mercadopago/process', [UserController::class, 'mercadoPagoProcess'])->name('mercadopagoProcess');
...
// Nova rota para enviar a requisição para o Mercado Pago
Route::post('send-mercadopago', [UserController::class, 'sendMercadopago'])->name('send-mercadopago');

// Nova rota para processar o pagamento retornado pelo Mercado Pago
Route::get('mercadopago/process', [AddFundsController::class, 'mercadoPagoProcess'])->name('mercadopago.process_payment');
